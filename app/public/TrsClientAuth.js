...
class TrsClientAuth {
    ...
    constructor(requestor) {
        ...
        if (state) {
            ...
            this.changeToMode(TrsClientAuth.LOGGED_ON_MODE);
        } else {
    ...
    logonOkay() {
        ...
        this.requestor.authorizeLogon(emailAddress, password, (mutationResult) => { 
            if (mutationResult.success) {
                this.authState.isOrgAdmin      = mutationResult.isOrgAdmin;
                this.authState.isSystemAdmin   = mutationResult.isSystemAdmin;
                this.authState.token = mutationResult.token;
                this.saveAuthState();
